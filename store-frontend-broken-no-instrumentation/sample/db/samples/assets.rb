unless ENV['SKIP_SAMPLE_IMAGES']
  ...
  products = {}
  products[:ror_baseball_jersey] = Spree::Product.find_by!(name: 'Datadog Baseball Jersey')
  products[:ror_tote] = Spree::Product.find_by!(name: 'Datadog Tote')
  products[:ror_bag] = Spree::Product.find_by!(name: 'Datadog Bag')
  products[:ror_jr_spaghetti] = Spree::Product.find_by!(name: 'Datadog Jr. Spaghetti')
  products[:ror_mug] = Spree::Product.find_by!(name: 'Datadog Mug')
  products[:ror_ringer] = Spree::Product.find_by!(name: 'Datadog Ringer T-Shirt')
  products[:ror_stein] = Spree::Product.find_by!(name: 'Datadog Stein')
  products[:spree_baseball_jersey] = Spree::Product.find_by!(name: 'Spree Baseball Jersey')
  products[:spree_stein] = Spree::Product.find_by!(name: 'Monitoring Stein')
  products[:spree_jr_spaghetti] = Spree::Product.find_by!(name: 'Spree Jr. Spaghetti')
  products[:spree_mug] = Spree::Product.find_by!(name: 'Monitoring Mug')
  ...
  products[:ruby_baseball_jersey] = Spree::Product.find_by!(name: 'Datadog Baseball Jersey')
